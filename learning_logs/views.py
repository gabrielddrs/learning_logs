...
def index(request):
    """Página principal de Learning Logs"""
...
def topic(request, topic_id):
    """Mostra um único assunto e suas entradas"""
...
def new_topic(request):
    ...
    if request.method != 'POST':
        ...
        # Se os dados forem válidos, ele salva os dados
        if form.is_valid():
            form.save()
...
def new_entry(request, topic_id):
    """Adiciona um nova entrada para um assunto particular"""
    topic = Topic.objects.get(id == topic_id)
